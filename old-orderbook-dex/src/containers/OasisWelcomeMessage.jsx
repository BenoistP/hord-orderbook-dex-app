...
export class OasisWelcomeMessageWrapper extends PureComponent {
  render() {
    ...
    return (
      <OasisMessage type={MSGTYPE_INFO} heading={'Get started!'} dismissible={true} onDismiss={actions.dismissMessage}>
        <ul>
          <li>
            <span styleName="Circle">
              <span styleName="Number">1</span>
            </span>
            <span styleName="Text">Go to wrap/unwrap and wrap ETH to turn it into W-ETH.</span>
          </li>
          <li>
            <span styleName="Circle">
            ...
            <span styleName="Text">
              Go to Trade and place new orders or trade existing orders by clicking on an open order on the order book
              to buy/sell into it.
            </span>
          </li>
          <li>
...
export default connect(null, mapDispatchToProps)(OasisWelcomeMessageWrapper);
