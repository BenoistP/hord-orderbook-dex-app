  ...
  render() {
    ...
    return false === isBestOffer ? (
      <InfoBoxWithIco color='danger' icon='warning'>
        WARNING: You have not chosen the best price available. Review the order
        book to find a better trade.
      </InfoBoxWithIco>
    ) : null;
  }
}
...
OasisNotTheBestOfferPriceWarningWrapper.displayName =
  'OasisNotTheBestOfferPriceWarning';
