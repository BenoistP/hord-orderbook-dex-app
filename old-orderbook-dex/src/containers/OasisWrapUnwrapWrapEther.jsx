...
export class OasisWrapUnwrapWrapEtherWrapper extends PureComponent {
  ...
  componentDidUpdate({ activeUnwrappedToken }) {
    if (this.props.activeUnwrappedToken && this.props.activeUnwrappedToken !== activeUnwrappedToken) {
...
export default connect(mapStateToProps, mapDispatchToProps)(OasisWrapUnwrapWrapEtherWrapper);
