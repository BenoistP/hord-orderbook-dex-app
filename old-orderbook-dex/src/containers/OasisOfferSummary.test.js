...
import { OasisOfferSummaryWrapper, mapStateToProps, mapDispatchToProps } from './OasisOfferSummary';
...
describe('(Container) OasisOfferSummary', () => {
  ...
  it('should render', () => {
    const wrapper = shallow(<OasisOfferSummaryWrapper {...props} />);
