...
export const SUBSCRIPTIONS_GROUP_GLOBAL_INITIAL =
  'SUBSCRIPTIONS/GROUP_GLOBAL/INITIAL';
export const SUBSCRIPTIONS_GROUP_ACCOUNT_SPECIFIC_INITIAL =
  'SUBSCRIPTIONS/GROUP_ACCOUNTS_SPECIFIC/INITIAL';

export const SUBSCRIPTIONS_LATEST_BLOCK = 'SUBSCRIPTIONS/LATEST_BLOCK';
export const SUBSCRIPTIONS_TOKEN_BALANCE_EVENTS =
  'SUBSCRIPTIONS/TOKEN_BALANCES';
export const SUBSCRIPTIONS_ORDERS_EVENTS = 'SUBSCRIPTIONS/ORDERS_EVENTS';
export const SUBSCRIPTIONS_ETHER_BALANCE_CHANGE_EVENTS =
  'SUBSCRIPTIONS/ETHER_BALANCE_CHANGE_EVENTS';
export const SUBSCRIPTIONS_LOG_TAKE_EVENTS = 'SUBSCRIPTIONS/LOG_TAKE_EVENTS';
export const SUBSCRIPTIONS_USER_LOG_TAKE_EVENTS =
  'SUBSCRIPTIONS/USER_LOG_TAKE_EVENTS';
export const SUBSCRIPTIONS_TOKEN_TRANSFER_EVENTS =
  'SUBSCRIPTIONS/TOKEN_TRANSFER_EVENTS';
export const SUBSCRIPTIONS_TOKEN_TRANSFER_HISTORY_EVENTS =
  'SUBSCRIPTIONS/TOKEN_TRANSFER_HISTORY_EVENTS';
export const SUBSCRIPTIONS_TOKEN_WRAP_UNWRAP_HISTORY_EVENTS =
  'SUBSCRIPTIONS/TOKEN_TRANSFER_HISTORY_EVENTS';
...
export const USER_TO_LOG_TAKE_OFFER_RELATION_TAKEN_BY_USER =
  'USER_TO_LOG_TAKE_RELATION/TAKEN_BY_USER';
export const USER_TO_LOG_TAKE_OFFER_RELATION_USER_MADE =
  'USER_TO_LOG_TAKE_RELATION/USER_MADE';
export const USER_TO_LOG_TAKE_OFFER_RELATION_NONE =
  'USER_TO_LOG_TAKE_RELATION/NONE';
