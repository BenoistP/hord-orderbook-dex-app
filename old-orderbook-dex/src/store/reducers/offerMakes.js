...
const makeOfferTransaction = createAction(
  ...
  ({
    ...
    const offer =
      getMarketNoProxyContractInstance().offer[
    ...
    if (
      ...
      dispatch(
        localChange(
          offerMakeType,
          'total',
          web3.toBigNumber(volume).mul(value).toFixed().toString(),
        ),
      );
    }
    dispatch(
...
const reducer = handleActions(
  {
    ...
    [resetActiveOfferMakeType]: (state) =>
      state.set('activeOfferMakeType', null),
