...
const wrapGNTTokenAction = createAction(
  WRAP_TOKEN_WRAPPER,
  async ({ brokerAddress, amountInWei, gasPrice = DEFAULT_GAS_PRICE }) =>
        ...
        createDepositBrokerEpic(
          ...
          async () => {
            ...
            testActions.lastNestedWrapGNT = nestedDispatch(
              ...
              wrapGNTToken(
                {
                  brokerAddress: depositBrokerAddress,
                  amountInWei: wrapAmount,
                },
                withCallbacks,
                async () => {
...
const clearDepositBroker = createAction(
  ...
  (tokenName, { gasPrice = DEFAULT_GAS_PRICE } = {}) =>
