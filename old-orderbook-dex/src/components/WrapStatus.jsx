...
class WrapStatus extends PureComponent {
  getStatus() {
    ...
    switch (activeTokenWrapStatus) {
      case TOKEN_WRAP_STATUS_AWAITING_TRANSFER_TO_BROKER_APPROVAL:
        break;
      case TOKEN_WRAP_STATUS_TRANSFER_TO_BROKER_PENDING:
        break;
      case TOKEN_WRAP_STATUS_TRANSFER_TO_BROKER_COMPLETE:
        break;
      case TOKEN_WRAP_STATUS_AWAITING_TRANSFER_TO_WRAPPER_CONTRACT_APROVAL:
        break;
      case TOKEN_WRAP_STATUS_WRAP_COMPLETE:
        break;
      default:
        return null;
    }
