  ...
  return (
    <div className={styles.NoEthereumSection}>
      ...
      <p className={styles.PNotFound}>
        OasisDEX requires an Ethereum client to be running and current. OasisDEX could not detect a client running which
        probably means it&#39;s not installed, running or is misconfigured.
      </p>
      <p className={styles.PUseClients}>Please use one of the following clients to connect to Ethereum:</p>
      ...
      <div>
        <p className={styles.PConnectGeth}>
          ...
          <b> geth</b> or <b>parity</b>, a more advanced configuration is needed. See the
          <a href="https://github.com/OasisDEX/oasis/wiki#network" rel="noopener noreferrer" target="_blank">
            {' '}
